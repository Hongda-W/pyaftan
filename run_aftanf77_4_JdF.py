...
atr1.aftanf77(tmin=5., tmax=20., vmin=0.5, vmax=4.5, phvelname='/projects/howa1663/Code/pyaftan/ak135.disp') # apply aftan to all 3 traes
atr2.aftanf77(tmin=5., tmax=20., vmin=0.5, vmax=4.5, phvelname='/projects/howa1663/Code/pyaftan/ak135.disp')
atr.aftanf77(tmin=5., tmax=20., vmin=0.5, vmax=4.5, phvelname='/projects/howa1663/Code/pyaftan/ak135.disp')
atr1.get_snr()
atr2.get_snr()
atr.get_snr()
